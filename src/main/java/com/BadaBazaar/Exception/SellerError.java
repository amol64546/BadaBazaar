...
public class SellerError extends CommonErrors {

  // 500 Internal server error.
  public static final Error VUE_SERVICE_UNAVAILABLE =
      new Error(HttpStatus.INTERNAL_SERVER_ERROR, 500000, "Unable to process the SELLER.",
          "Kindly try again after some time or contact the support team ");

  // 404 not found
  public static final Error SELLER_NOT_FOUND = new Error(HttpStatus.NOT_FOUND, 404000,
      "SELLER not found.", "Please create a SELLER first.");

  // 401 Unauthorized
  public static final Error ACCESS_VIOLATION =
      new Error(HttpStatus.UNAUTHORIZED, 401000, "Tenant is not autorized to access the SELLER.",
          "Please request for read/write or execute access to the SELLER owner.");
